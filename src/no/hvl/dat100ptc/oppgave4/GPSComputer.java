...
public class GPSComputer {
	...
	public double maxSpeed() {
		// Finne høgaste hastighet på ruten
		double maxspeed = 0;
	...
	public double averageSpeed() {
		// Finne gj.snitt fart på heile turen
		double average = 0;
	...
	// Beregne kalorier gitt vekt og tid der det kjørast med en gitt hastighet
